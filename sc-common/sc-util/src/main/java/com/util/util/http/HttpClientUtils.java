...
public class HttpClientUtils {
     ...
     * @throws Exception
     */
    public static HttpClientResult doPut(String url, Map<String, String> headers, String json) throws Exception {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPut httpPut = new HttpPut(url);
        RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(CONNECT_TIMEOUT).setSocketTimeout(SOCKET_TIMEOUT).build();
        httpPut.setConfig(requestConfig);
        packageHeader(headers, httpPut);
        packageJson(json, httpPut);
        CloseableHttpResponse httpResponse = null;
        try {
            return getHttpClientResult(httpResponse, httpClient, httpPut);
        } finally {
     ...
     * @throws UnsupportedEncodingException
     */
    public static void packageJson(String json, HttpEntityEnclosingRequestBase httpMethod) {
    ...
    public static HttpClientResult getHttpClientResult(CloseableHttpResponse httpResponse,
        ...
        if (httpResponse != null && httpResponse.getStatusLine() != null) {
            ...
            logger.info("http请求返回状态 StatusCode={};content={}", httpResponse.getStatusLine().getStatusCode(), content);
